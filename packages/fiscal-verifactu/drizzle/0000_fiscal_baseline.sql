...
CREATE TABLE "envios" (
	...
	"reconciled_resubmit_at" timestamp with time zone,
...
CREATE TABLE "registros_facturacion" (
	...
	"facturas_rectificadas" jsonb,
	"facturas_sustituidas" jsonb,
	"importe_rectificacion" jsonb,
	"destinatarios" jsonb,
	...
	CONSTRAINT "registros_tipo_factura_rectificativa_ck" CHECK ("registros_facturacion"."tipo_rectificativa" is null or ("registros_facturacion"."tipo_factura" is not null and "registros_facturacion"."tipo_factura" ~ '^R[1-5]$')),
