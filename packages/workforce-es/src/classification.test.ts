...
import { WORKFORCE_ES_CLASSIFICATION } from "./classification.js";
...
describe("WORKFORCE_ES_CLASSIFICATION", () => {
  ...
  it("classifies exactly the tables this module's migrations create", () => {
    ...
    // The control: the assertion that catches a NEW table nobody classified passes against an
    // empty `created`, so it says nothing unless the scan actually found the migrations.
