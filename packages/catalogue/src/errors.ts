...
declare module "@waitron/shared" {
  interface ErrorParams {
    ...
    /** A product with Active variants was rung up without one: from a menu offer that named no
     * variant, or on the plain `productId` path, which cannot name one at all. */
