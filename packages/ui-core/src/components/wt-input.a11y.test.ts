...
// axe does not score a placeholder's contrast, so the placeholder state measures its own ratio. The
// parser reads rgb()/rgba() only, which is why each colour is checked for that form first.
