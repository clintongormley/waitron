 ...
 * are hand-written in the paired --custom migration, exactly as 0036 does for `till_layouts` and
 * 0048 for `table_service_statuses`. The `inmutabilidad` guard in packages/fiscal-verifactu scans
