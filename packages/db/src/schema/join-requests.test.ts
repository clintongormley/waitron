...
// no grants, so that question has no counterpart here and the case is deleted rather than kept in a
// form that asserts nothing. Nothing in this package now states which privileges this table was
// granted.
