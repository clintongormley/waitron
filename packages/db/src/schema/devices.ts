 ...
 * and later tables may reference it. **Nothing in the database refuses the DELETE**:
 * `delete from devices` on a real row succeeds, measured 2026-09-23 on Node v26.7.0 against the
 * core migration set. The no-hard-delete rule lives in the code alone, as it does for
 * `kitchen_stations`.
 *
