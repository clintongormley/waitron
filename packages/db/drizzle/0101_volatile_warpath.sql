...
-- (SP-B3.2 Phase A). This is the paired --custom migration for 0100; drizzle-kit emits none of FORCE,
-- CREATE/ALTER POLICY, GRANT or the composite bare-column FKs, so they are hand-written here.
--
-- Because 0100 RENAMEd the table (rather than dropping and recreating it), the tenant-isolation policy,
