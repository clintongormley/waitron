...
-- statements below do the change with an explicit `USING`, and the generated ones then restate a
-- type the column already has and drop a default it no longer carries: both are accepted and do
-- nothing.
--
