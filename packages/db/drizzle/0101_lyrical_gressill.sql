...
-- end state the generated 0101 snapshot records (same constraint names + definitions) without severing
-- the FK dependency. The policy, FORCE RLS, grants and the composite FKs all survive the table rename;
-- their name changes are in the paired --custom migration 0102.
