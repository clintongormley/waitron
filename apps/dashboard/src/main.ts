...
// api on boot — firstUpdated → #probeSession → api.listStaff() — to decide whether to open on the
// staff screen (a live session) or the login screen. Excluded from coverage (see vitest.config.ts):
