export const en = {
  ...
  "printers.character_table_hint":
    "Print tables 0–15 first. Compare both A and B with the examples below, then choose the first matching code. If none matches, print the next range.",
  ...
  "menu_prices.show_variants": "Show the variants of {name}",
  "menu_prices.hide_variants": "Hide the variants of {name}",
  ...
  "menu_prices.price_inherited": "(product's own price)",
...
export const es: Record<StringKey, string> = {
  ...
  "printers.character_table_hint":
    "Imprime primero las tablas 0–15. Compara las líneas A y B con los ejemplos de abajo y elige el primer código que coincida. Si no hay ninguno, imprime el siguiente rango.",
  ...
  "menu_prices.show_variants": "Mostrar las variantes de {name}",
  "menu_prices.hide_variants": "Ocultar las variantes de {name}",
  ...
  "menu_prices.price_inherited": "(precio propio del producto)",
