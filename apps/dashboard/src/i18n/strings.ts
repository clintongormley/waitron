...
export const en = {
  ...
  "profile.password_recovery":
    "To set a password, sign out and choose “Forgot your password?” when logging in.",
  ...
  "profile.remove_passkey_number": "Remove passkey {number}",
  "login.email": "Email",
  ...
  "login.logging_in_as": "Logging in as:",
  ...
  "login.forget_account": "Forget this account",
  "login.try_another_way": "Try another way",
  "login.use_passkey_heading": "Use your passkey",
  "login.other_ways_heading": "Choose another way to log in",
  ...
  "login.reset_by_email": "Forgot your password?",
  ...
  "account.code_required": "Enter the 6-digit invitation code.",
  "account.validating_link": "Checking your invitation…",
  "account.resend_invitation": "Send a new invitation",
  "account.invitation_resent":
    "If this account is waiting for activation, a new invitation has been sent.",
  "login.use_invitation_code": "Use an invitation code",
  "login.invitation_code_hint": "Enter the code from your invitation email at the restaurant.",
  // Staff screen
  "staff.title": "Users",
...
export const es: Record<StringKey, string> = {
  ...
  "profile.passkey_number": "Passkey {number}",
  "profile.remove_passkey_number": "Eliminar passkey {number}",
  ...
  "login.forget_account": "Olvidar esta cuenta",
  "login.try_another_way": "Probar otra opción",
  "login.use_passkey_heading": "Usa tu passkey",
  "login.other_ways_heading": "Elige otra forma de iniciar sesión",
  ...
  "account.invitation_code": "Código de invitación",
  "account.code_required": "Introduce el código de invitación de 6 dígitos.",
  "account.validating_link": "Comprobando tu invitación…",
  "account.resend_invitation": "Enviar una invitación nueva",
  "account.invitation_resent":
    "Si esta cuenta está pendiente de activación, se ha enviado una invitación nueva.",
  "login.use_invitation_code": "Usar un código de invitación",
  "login.invitation_code_hint": "Introduce en el restaurante el código de tu correo de invitación.",
