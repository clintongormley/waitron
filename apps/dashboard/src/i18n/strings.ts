...
export const en = {
  ...
  "profile.authenticator_scan":
    "Scan this setup address with your authenticator app, then enter its code.",
  ...
  "login.second_factor": "Authenticator or recovery code (if enabled)",
...
export const es: Record<StringKey, string> = {
  ...
  "profile.authenticator_scan":
    "Escanea esta dirección con tu aplicación de autenticación e introduce el código.",
  ...
  "login.second_factor": "Código del autenticador o de recuperación (si está activado)",
