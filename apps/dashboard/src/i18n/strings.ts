...
export const en = {
  ...
  "login.reset_by_email": "Email me a password reset link",
  "login.reset_by_email_hint":
    "If this email belongs to an account, we will send a link to create a new password.",
  "login.reset_sent": "If that email belongs to an account, we have sent a reset link.",
...
export const es: Record<StringKey, string> = {
  ...
  "login.reset_by_email": "Recibir un enlace para restablecer la contraseña",
  "login.reset_by_email_hint":
    "Si este correo pertenece a una cuenta, enviaremos un enlace para crear una contraseña nueva.",
  "login.reset_sent": "Si ese correo pertenece a una cuenta, te hemos enviado un enlace.",
