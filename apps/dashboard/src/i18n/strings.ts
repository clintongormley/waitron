export const en = {
  ...
  "labels.delete_count": "It is taken off {count} products.",
  "labels.delete_count_one": "It is taken off 1 product.",
...
export const es: Record<StringKey, string> = {
  ...
  "labels.delete_count": "Se quitará de {count} productos.",
  "labels.delete_count_one": "Se quitará de 1 producto.",
