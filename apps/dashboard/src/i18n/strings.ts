...
export const en = {
  ...
  "editor.dietary": "Dietary suitability",
  "editor.add_diet": "Add suitability",
  "editor.search_diets": "Search suitability",
  ...
  "product.no_station": "— service route, then reporting category, then venue default —",
...
export const es: Record<StringKey, string> = {
  ...
  "editor.inferred": "Inferido",
  "editor.allergens": "Alérgenos",
  "editor.dietary": "Aptitud dietética",
  "editor.add_diet": "Añadir aptitud",
  "editor.search_diets": "Buscar aptitud",
  ...
  "product.no_station": "— ruta del servicio, luego categoría de informes, luego valor del local —",
