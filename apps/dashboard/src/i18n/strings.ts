...
export const en = {
  ...
  "printers.delete_confirm": "Confirm delete?",
  ...
  "printers.preview_notice":
    "Text preview of the stored print job. Characters and layout may differ from the paper copy; QR codes are shown as text.",
  "printers.preview_qr_data": "QR code content",
  "printers.preview_graphics_omitted": "Images are not shown.",
  "printers.preview_incomplete": "Some content could not be previewed.",
  "printers.preview_empty": "This job has no printable text.",
  ...
  "account.show_confirm_pin": "Show PIN confirmation",
  "account.hide_confirm_pin": "Hide PIN confirmation",
  ...
  "printers.pairing_extend": "Extend",
...
export const es: Record<StringKey, string> = {
  ...
  "printers.delete_confirm": "¿Confirmar eliminación?",
  ...
  "printers.preview_notice":
    "Vista de texto del trabajo guardado. Los caracteres y el diseño pueden diferir de la copia en papel; los códigos QR se muestran como texto.",
  "printers.preview_qr_data": "Contenido del código QR",
  "printers.preview_graphics_omitted": "Las imágenes no se muestran.",
  "printers.preview_incomplete": "No se ha podido mostrar parte del contenido.",
  "printers.preview_empty": "Este trabajo no contiene texto imprimible.",
  ...
  "account.show_confirm_pin": "Mostrar la confirmación del PIN",
  "account.hide_confirm_pin": "Ocultar la confirmación del PIN",
  ...
  "printers.pairing_extend": "Ampliar",
