...
export const en = {
  ...
  "modifiers.default_value": "Yes selected by default",
  ...
  "editor.unit_required": "Choose a unit.",
...
export const es: Record<StringKey, string> = {
  ...
  "modifiers.yes-no": "Sí/no",
  "modifiers.available": "Disponible",
  "modifiers.unavailable": "No disponible",
  ...
  "modifiers.default_value": "Sí seleccionado de forma predeterminada",
  ...
  "editor.unit_required": "Elige una unidad.",
