...
export const en = {
  ...
  "modifiers.invalidates_dietary": "Dietary preferences",
  ...
  "editor.name": "Name",
  "editor.name_required": "Enter a name in the default language.",
...
export const es: Record<StringKey, string> = {
  ...
  "modifiers.invalidates_dietary": "Preferencias dietéticas",
  ...
  "editor.name": "Nombre",
  "editor.name_required": "Introduce un nombre en el idioma predeterminado.",
