...
export const en = {
  ...
  // Sala (floor-plan) config screen — zones + tables
  "sala.title": "Floor plan",
  "sala.zones_title": "Zones",
  "sala.tables_title": "Tables",
  "sala.zone_name": "Name",
  "sala.zone_order": "Order",
  "sala.new_zone": "New zone",
  "sala.add_zone": "Add zone",
  "sala.no_zones": "No zones yet",
  "sala.table_label": "Label",
  "sala.table_capacity": "Seats",
  "sala.table_zone": "Zone",
  "sala.new_table": "New table",
  "sala.add_table": "Add table",
  "sala.no_zone": "— no zone —",
  "sala.no_tables": "No tables yet",
  // Person form
  "person.new": "New user",
  "person.name": "Name",
  "person.role": "Role",
...
export const es: Record<StringKey, string> = {
  ...
  "sala.title": "Sala",
  "sala.zones_title": "Zonas",
  "sala.tables_title": "Mesas",
  "sala.zone_name": "Nombre",
  "sala.zone_order": "Orden",
  "sala.new_zone": "Nueva zona",
  "sala.add_zone": "Añadir zona",
  "sala.no_zones": "Aún no hay zonas",
  "sala.table_label": "Etiqueta",
  "sala.table_capacity": "Plazas",
  "sala.table_zone": "Zona",
  "sala.new_table": "Nueva mesa",
  "sala.add_table": "Añadir mesa",
  "sala.no_zone": "— sin zona —",
  "sala.no_tables": "Aún no hay mesas",
