...
export const en = {
  ...
  "modifiers.default_quantity": "Default quantity",
  "modifiers.default_choice": "Default choice",
  "modifiers.no_default": "No default",
  "modifiers.yes_label": "Yes label",
  "modifiers.no_label": "No label",
  "modifiers.default_value": "Yes selected by default",
  "modifiers.move_up": "Move up",
  "modifiers.move_down": "Move down",
  "modifiers.problem": "There is a problem with this form. Check the highlighted fields.",
  ...
  "modifiers.defaults_invalid":
    "Defaults must use available choices and fit within the quantity limits.",
  ...
  "units.delete_title": "Delete unit?",
  "units.delete_body": "Products using this unit must be changed before you can delete it.",
...
export const es: Record<StringKey, string> = {
  ...
  "modifiers.default_quantity": "Cantidad predeterminada",
  "modifiers.default_choice": "Opción predeterminada",
  "modifiers.no_default": "Sin valor predeterminado",
  "modifiers.yes_label": "Etiqueta de sí",
  "modifiers.no_label": "Etiqueta de no",
  "modifiers.default_value": "Sí seleccionado de forma predeterminada",
  "modifiers.move_up": "Subir",
  "modifiers.move_down": "Bajar",
  "modifiers.problem": "Hay un problema con este formulario. Revisa los campos resaltados.",
  ...
  "modifiers.defaults_invalid":
    "Los valores predeterminados deben usar opciones disponibles y respetar los límites de cantidad.",
  ...
  "units.delete_title": "¿Eliminar la unidad?",
  "units.delete_body": "Antes debes cambiar los productos que usan esta unidad.",
