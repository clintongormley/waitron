export const en = {
  ...
  "menu_status.current_detail": "Version {number} · {time}",
  "menu_status.changed": "Unpublished changes",
  "menu_status.changed_detail": "Live: version {number} · {time}",
...
export const es: Record<StringKey, string> = {
  ...
  "menu_status.current_detail": "Versión {number} · {time}",
  "menu_status.changed": "Cambios sin publicar",
  "menu_status.changed_detail": "Publicada: versión {number} · {time}",
