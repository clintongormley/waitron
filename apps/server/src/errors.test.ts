...
// The booking.* error-code registration tests moved to @waitron/bookings/src/errors.test.ts with the
// codes themselves (SP1). `table.not_found` moved to @waitron/db's registry; both are still constructed
// under this app's compilation via those packages' augmentations.
