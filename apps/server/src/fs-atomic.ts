 ...
 * `mode` is applied by `writeFile` on creating the temp file, and `rename` preserves it on the
 * target. It is REQUIRED: both callers write secrets and pass `0o600`, so there is no
