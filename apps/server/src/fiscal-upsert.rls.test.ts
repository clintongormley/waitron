...
// immutable properties are Task 6 (fiscal-apply.rls.test.ts); this file proves the OTHER half of the
...
// real Hono `app.request` wire, applied as the non-superuser `sync_applier` under FORCE RLS. PGlite
