 ...
 * (its `node_roles.singleton_role = 'primary'`). A mirror or a sell-only local secondary returns a
 * trivial empty pass — running drain/reconcile there would submit to AEAT / settle for a host that must not
