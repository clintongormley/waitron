...
// compute node, #33, not the till). The step between `sql/bootstrap-tenant.sql` and
// `record-one-sale.ts`: a bootstrapped node has no `registro_sif` row, and `recordSale` refuses with
// `sif.not_registered` until it does.
//
