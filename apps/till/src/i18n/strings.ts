...
export const en = {
  ...
  // (shown for every product) and the meat-gated doneness picker. `line.note.*` label + placeholder the
  // textarea; `doneness.label` names the select, `doneness.none` is its blank "no preference" default,
  ...
  "doneness.rare": "Rare",
  "doneness.medium_rare": "Medium rare",
  "doneness.medium": "Medium",
  "doneness.medium_well": "Medium well",
  "doneness.well_done": "Well done",
  ...
  "table.action_split": "Split by item",
  ...
  "sale.unconfirmed":
    "The server did not answer. Check whether the sale went through before trying again.",
} as const;
...
export const es: Record<StringKey, string> = {
  ...
  "action.print_receipt": "Imprimir recibo",
  "action.payment_slip": "Justificante de pago",
  ...
  "doneness.medium_rare": "Al punto poco hecha",
  "doneness.medium": "Al punto",
  "doneness.medium_well": "Al punto pasada",
  "doneness.well_done": "Muy hecha",
  ...
  "table.action_split": "Dividir por artículo",
