 ...
 * (`packages/media/drizzle/0001_image_references.sql` carries the reasoning). Named here only
 * because the assertion below is an EQUALITY over every non-append-only trigger.
 */
