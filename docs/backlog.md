...
- **CI test-tier speedup — remaining rollout (from #112 phase 1 + #113 phase 1b + #114 phase 2 + #116 phase 3 + #117 phase 4 + #118 phase 5).** The
  ...
  **`@waitron/workforce`** (#118 — 7 suites, `core_identity_workforce`, 3 roles, kept `singleFork`). What
  ...
  - **P6..Pn — the remaining 12 real-PG packages** (sync,
