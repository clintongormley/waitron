...
**Dashboard login shortcuts: implemented; automated gates passed** (owner, 2026-09-10;
...
and passkey enrolment. Native passkey prompts and a physical authenticator QR scan remain device
