...
- **CI test-tier speedup — remaining rollout (from #112 phase 1 + #113 phase 1b + #114 phase 2 + #116 phase 3 + #117 phase 4).** The
  ...
  **`@waitron/payments`** (#116 — 8 suites, one `core_payments` template, 3 probe roles, kept `singleFork`) AND
  **`@waitron/fiscal-verifactu`** (#117 — 11 suites, `core_fiscal`, 4 roles incl. a shared `rls_probe`, `maxForks: 4`). What
  ...
  - **P5..Pn — the remaining 13 real-PG packages** (workforce, sync,
