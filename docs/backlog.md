...
- **Every package to the high coverage bar, `98/98/98/95` — OPEN (owner decision 2026-09-23).**
  ...
  plan; 100/100/100/99.03); `payments-sumup` (2026-09-23 — tests for the default one-second
  poll, a reversal with no row or no SumUp key, a removed reader's status, a declined duplicate
  incident, and the dashboard dialogs' single-flight, detach and dismiss paths;
