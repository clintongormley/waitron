...
- **Every package to the high coverage bar, `98/98/98/95` — OPEN (owner decision 2026-09-23).**
  ...
  (branch `test/coverage-catalogue`, 2026-09-23 — tests for listing and renaming a menu's sections,
  the unit reads and writes refused for an id that names nothing, a variant refused as
